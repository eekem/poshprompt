        ...
        <div className="relative z-10 w-full max-w-[480px]">
          <div className="bg-surface-dark/40 backdrop-blur-xl border border-border-dark p-8 md:p-12 rounded-xl shadow-2xl">
            ...
            <div className="grid grid-cols-3 gap-4">
              {/* Google */}
              <button className="flex flex-col items-center justify-center gap-2 h-20 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all group">
